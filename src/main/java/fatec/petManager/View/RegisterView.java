...
public class RegisterView extends JFrame {
	...
	public RegisterView() {
		...
		JLabel lbl_nome = new JLabel("Nome do Pet:");
		lbl_nome.setFont(new Font("Yu Gothic", Font.ITALIC, 20));
		
		JLabel lbl_tipo = new JLabel("Espécie/Raça:");
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPane.createSequentialGroup()
							...
							.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(gl_contentPane.createSequentialGroup()
									.addComponent(lbl_tipo, GroupLayout.PREFERRED_SIZE, 144, GroupLayout.PREFERRED_SIZE)
									.addPreferredGap(ComponentPlacement.RELATED, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
									.addComponent(textField_1, GroupLayout.PREFERRED_SIZE, 363, GroupLayout.PREFERRED_SIZE))
								.addGroup(gl_contentPane.createSequentialGroup()
